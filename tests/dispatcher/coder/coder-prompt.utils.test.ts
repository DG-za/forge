...
import { buildCoderPrompt, buildFixPrompt } from '@/dispatcher/coder/coder-prompt.utils';
import { CODER_SYSTEM_PROMPT } from '@/dispatcher/coder/coder-system-prompt.utils';
import type { CoderTask, QualityGateResult } from '@/dispatcher/coder/coder.types';
